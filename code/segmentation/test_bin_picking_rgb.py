...
#object_classes = {0: 'background', 1: 'cup'}
#object_classes = {0: 'background', 1: 'juice'}
object_classes = {0: 'background', 1: 'cup', 2: 'juice'}

test_path = 'datasets/bin_picking_dataset/'
